...
When(/^hacemos click en la seccion FEATURES$/, function (callback) {
    homePage.clickFeatures(callback);
});

Then(/^se abre la seccion de FEATURES$/, function (callback) {
...
Then(/^se abre la seccion de RESOURCES$/, function (callback) {
...
Then(/^se abre la seccion EVENTS$/, function (callback) {
